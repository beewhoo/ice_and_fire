...
class DragonTest < ActiveSupport::TestCase
  ...
  def test_that_young_dragons_from_asoiaf
    ...
    young_dragon = build(:dragon, age:3)
  ...
  def test_that_middle_dragons_from_targ_dynasty
    # use your knowledge of factories to make this test pass!
    middle_dragon = build(:dragon, age:20)
  ...
  def test_that_stranger_cannot_mount
    # use your knowledge of factories to make this test pass!
    rider1 = build(:rider, name:'Aegon')
    rider2 = build(:rider, name:'Kevin')
    dragon = build(:dragon, name:'Balerion', rider:rider2)

    # not allowed to change the assert statement!
    assert_equal("Balerion bucks off Aegon!", dragon.mount(rider1))
  end
  ...
  def test_that_the_right_rider_can_mount
    ...
    rider1 = build(:rider, name:'Aegon')
    dragon = build(:dragon, name:'Balerion', rider:rider1)

    # not allowed to change the assert statement!
    assert_equal("Aegon soars into the air on Balerion's back!", dragon.mount(rider1))
  end
